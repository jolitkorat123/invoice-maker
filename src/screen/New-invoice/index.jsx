...
// // ✅ ItemCard Component - New component to display selected items
// const ItemCard = ({ item, onEdit, onDelete }) => (
//   <View style={styles.itemCard}>
//     <View style={styles.itemCardContent}>
//       <Text style={styles.itemName} numberOfLines={1}>{item.itemName}</Text>
//       <Text style={styles.itemDetails}>
//         {item.quantity} {item.unit} × ₹{parseFloat(item.itemPrice || 0).toFixed(2)}
//       </Text>
//       {item.discount && (
//         <Text style={styles.itemDetails}>
...
//       <Text style={styles.itemAmount}>₹{parseFloat(item.amount || 0).toFixed(2)}</Text>
//       <View style={styles.itemActions}>
//         <TouchableOpacity onPress={() => onEdit(item)} style={styles.actionButton}>
//           <Ionicons name="pencil" size={16} color="#4CD04D" />
//         </TouchableOpacity>
...
//   // ✅ Removed quantity and price states
...
//   // ✅ Set selected items from route params if available
//   useEffect(() => {
...
//   // ✅ Set edited item from route params if available - FIXED VERSION
//   useEffect(() => {
//     if (route.params?.editedItem) {
//       const editedItem = route.params.editedItem;
//       console.log('Received edited item:', editedItem);
      
//       // Recalculate amount for the edited item
...
//       console.log('Updated item with recalculated amount:', updatedItem);
...
//   }, [selectedItems, discountValue, discountType, shipping]);
...
//   // ✅ CALCULATION FUNCTIONS - UPDATED (removed quantity and price)
...
//   // ✅ Handle item edit - Navigate to Add-item screen with the item to edit
...
//           text: "Delete",
//           onPress: () => {
//             const updatedItems = selectedItems.filter(item => item.id !== itemToDelete.id);
//             setSelectedItems(updatedItems);
//           },
//           style: "destructive"
//         }
...
//           {/* ✅ Display selected items as cards */}
//           {selectedItems.length > 0 && (
...
// // ✅ ItemCard Component with Image Icons
// const ItemCard = ({ item, onEdit, onDelete }) => (
//   <View style={styles.itemCard}>
//     <View style={styles.itemCardContent}>
//       <Text style={styles.itemName} numberOfLines={1}>{item.itemName}</Text>
...
//         <TouchableOpacity onPress={() => onEdit(item)} style={styles.actionButton}>
//           <Image 
//             source={require("../../../assets/screen-14/Edit.png")} 
//             style={styles.actionIcon}
//           />
//         </TouchableOpacity>
//         <TouchableOpacity onPress={() => onDelete(item)} style={styles.actionButton}>
//           <Image 
//             source={require("../../../assets/screen-14/Delete.png")} 
//             style={styles.actionIcon}
//           />
//         </TouchableOpacity>
//       </View>
...
//   // ✅ Set selected payment method from route params
//   useEffect(() => {
//     if (route.params?.selectedPaymentMethod) {
//       setSelectedPaymentMethod(route.params.selectedPaymentMethod);
//     }
...
//   // ✅ Set selected terms from route params
//   useEffect(() => {
//     if (route.params?.selectedTerms) {
//       setSelectedTerms(route.params.selectedTerms);
//     }
...
//   // ✅ Set selected signature from route params
//   useEffect(() => {
//     if (route.params?.selectedSignature) {
//       setSelectedSignature(route.params.selectedSignature);
//     }
...
//   // ✅ Set selected items from route params
//   useEffect(() => {
//     if (route.params?.selectedItems) {
//       setSelectedItems(route.params.selectedItems);
//     }
...
//   // ✅ Set edited item from route params - SIMPLIFIED VERSION
//   useEffect(() => {
//     if (route.params?.editedItem) {
//       const editedItem = route.params.editedItem;
//       console.log('Received edited item:', editedItem);
...
//   // ✅ Navigate to item selection - UPDATED
//   const navigateToItemSelection = () => {
//     navigation.navigate("Item-list", {
//       isSelectionMode: true,
//       selectedItems: selectedItems,
...
//   // ✅ Handle item edit - UPDATED with callback
//   const handleEditItem = (item) => {
//     navigation.navigate("Add-item", { 
//       item,
//       onItemEdit: (editedItem) => {
//         // Update the selected items array directly via callback
...
// ✅ ItemCard Component - Updated to match the image design
const ItemCard = ({ item, onEdit, onDelete }) => (
  <View style={styles.itemCard}>
    <View style={styles.itemCardContent}>
      <Text style={styles.itemName} numberOfLines={1}>{item.itemName}</Text>
...
export default function NewInvoiceScreen() {
  ...
  // ✅ Handle item edit - Navigate to Add-item screen with the item to edit and a callback
  const handleEditItem = (item) => {
    navigation.navigate("Add-item", { 
      item,
      onItemEdit: (editedItem) => {
        console.log('Editing item via callback:', editedItem);
        
        // Update the selected items array
        const updatedItems = selectedItems.map(i => 
          i.id === editedItem.id ? { ...editedItem, id: i.id } : i
        );
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={{ backgroundColor: '#ffe', padding: 10, marginBottom: 10, display: 'none' }}>
          <Text style={{ fontSize: 10 }}>DEBUG: {selectedItems.length} items</Text>
          {selectedItems.map((item, index) => (
            <Text key={index} style={{ fontSize: 8 }}>
              {item.itemName} - ₹{item.amount} (ID: {item.id})
            </Text>
          ))}
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  // ✅ Item Cards - Updated to match image design
  itemsContainer: {
    marginTop: 10,
    marginBottom: 10,
  },
