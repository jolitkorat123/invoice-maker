...
////fully working code with all changes applied
// import React, { useState, useEffect } from "react";
// import {
//   View,
//   Text,
...
//     // Navigate to edit item screen or show edit modal
...
//       <Text style={styles.itemAmount}>₹{parseFloat(item.itemPrice || 0).toFixed(2)}</Text>
//     </View>
//     <View style={styles.itemActions}>
//       <TouchableOpacity onPress={() => onEdit(item)} style={styles.actionButton}>
//         <Ionicons name="pencil" size={16} color="#4CD04D" />
...
//   // ✅ Set edited item from route params if available
//   useEffect(() => {
