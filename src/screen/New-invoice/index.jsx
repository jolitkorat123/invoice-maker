...
// // const styles = StyleSheet.create({
// //   background: { flex: 1 },
// //   container: { padding: 20, paddingBottom: 100 }, // Increased paddingBottom to accommodate buttons
...
//           {/* ✅ Payment Method from DB - NOW SHOWING VALUE */}
//           <SectionItem
//             icon={require("../../../assets/screen-14/debit-card.png")}
//             label="Payment Method"
...
//         {/* ✅ Terms & Signature - NOW SHOWING VALUE */}
//         <View style={styles.sectionCard}>
//           <SectionItem
//             icon={require("../../../assets/screen-14/terms-and-conditions.png")}
//             label="Terms & Condition"
...
//       // Save invoice data with client information
//       await db.runAsync(
//         `INSERT INTO invoices (
//           invoiceId, 
//           startDate, 
...
export default function NewInvoiceScreen() {
  ...
  // ✅ Refresh signature when screen comes into focus
  useEffect(() => {
    const refreshSignature = async () => {
      if (db) {
        try {
          const signatureResult = await db.getFirstAsync(
            "SELECT * FROM signatures ORDER BY id DESC LIMIT 1"
          );
          if (signatureResult) {
            setLatestSignature(signatureResult.fileUri);
    ...
    const unsubscribe = navigation.addListener('focus', refreshSignature);
