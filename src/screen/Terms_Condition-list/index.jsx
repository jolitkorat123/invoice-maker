...
//   const loadTerms = () => {
//     try {
//       const result = db.getAllSync('SELECT * FROM terms_conditions ORDER BY id DESC;');
//       const data = result.map((item) => ({
//         id: item.id.toString(),
//         text: item.text,
//         date: `Added on ${new Date(item.createdAt).toLocaleDateString()}`,
//       }));
//       setTermsList(data);
//     } catch (err) {
...
//     if (tempValue.trim()) {
//       try {
//         db.runSync('INSERT INTO terms_conditions (text) VALUES (?);', [tempValue.trim()]);
...
//   const from = route?.params?.from || ''; // 'settings' or e.g. 'invoice'
...
//         id: Number(item.id),
//         text: item.text || '',
//         // keep date simple for cross-platform consistency
...
//   const handleSaveNewTerms = () => {
//     const value = tempValue.trim();
//     if (!value) return;
//     try {
//       db.runSync('INSERT INTO terms_conditions (text) VALUES (?);', [value]);
//       setModalVisible(false);
//       setTempValue('');
//       loadTerms();
//     } catch (err) {
...
//         onPress: () => {
//           try {
//             db.runSync('DELETE FROM terms_conditions WHERE id = ?;', [id]);
//             loadTerms();
//           } catch (err) {
...
//     if (from === 'settings') return; // no save in settings mode
//     if (selectedIndex < 0 || selectedIndex >= termsList.length) return;

//     const selected = termsList[selectedIndex];
//     // Pass selected.text back to previous screen if it provided a handler
...
//         {/* Invoice/others: show selection tick */}
//         {from !== 'settings' && (
//           <Image
//             source={require('../../../assets/screen-27/select.png')}
//             style={[
...
//   return (
//     <SafeAreaView style={styles.container}>
//       <LinearGradient colors={['#8aea8a27', 'rgba(76, 208, 76, 0)']} style={styles.gradientBackground}>
//         <View style={{ flex: 1 }}>
//           {/* Header */}
//           <View style={styles.header}>
...
//           {/* Add New */}
//           <View style={styles.fixedTop}>
//             <TouchableOpacity style={styles.newSignatureCard} onPress={handleAddNewTerms}>
//               <View style={styles.leftContent}>
//                 <Image
//                   source={require('../../../assets/screen-24/terms-and-conditions.png')}
//                   style={styles.signatureIcon}
...
//           {/* List */}
//           <ScrollView style={styles.termsList} contentContainerStyle={{ paddingBottom: 100 }}>
//             {termsList.length > 0 ? (
//               termsList.map((item, index) => (
...
//             ) : (
//               <View style={styles.emptyState}>
//                 <Text style={styles.emptyStateText}>No terms and conditions added yet.</Text>
//                 <Text style={styles.emptyStateSubtext}>
//                   Tap the "+" button above to add new terms.
//                 </Text>
//               </View>
...
//         {/* Save button only when NOT from settings */}
//         {from !== 'settings' && (
...
//             <View style={styles.modalContent}>
//               <View style={styles.modalHeader}>
//                 <Text style={styles.modalTitle}>Add New Terms & Conditions</Text>
...
//   signatureIcon: { width: 24, height: 24, resizeMode: 'contain', marginRight: 12 },
...
//   termslist: { fontSize: 16, fontWeight: '500', marginBottom: 10 },
//   termsList: { flex: 1, marginBottom: 10 },
//   optionContainer: {
//     flexDirection: 'row',
//     justifyContent: 'space-between',
//     alignItems: 'center',
...
//   },
//   termItem: { flex: 1 },
//   termText: { fontSize: scale(15), color: '#333', marginBottom: 4 },
//   termDate: { fontSize: scale(12), color: '#888' },
...
//   modalLabel: { fontSize: 16, fontWeight: '500', marginBottom: 8, color: '#333' },
//   textAreaWrapper: { borderWidth: 1, borderColor: '#ddd', borderRadius: 8, marginBottom: 16 },
//   textArea: { padding: 12, minHeight: 150, textAlignVertical: 'top', fontSize: 15 },
...
//   saveModalButton: { backgroundColor: '#4CD04D' },
//   saveModalButtonText: { color: '#fff', fontWeight: '500' },
// });
