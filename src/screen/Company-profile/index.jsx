...
//     setLoading(true);
//     try {
//       const result = await database.getAllAsync(`SELECT * FROM company ORDER BY id DESC LIMIT 1`);
//       if (result.length > 0) {
...
//           businessNature: latest.businessNature || '',
//         });
//         if (latest.logo) setLogo(latest.logo);
//       }
//     } catch (error) {
//       console.error("❌ Fetch Error:", error);
//     }
...
//         {loading ? (
//           <ActivityIndicator size="large" color="#4CD04D" style={{ marginTop: 50 }} />
//         ) : (
//           <ScrollView>
//             <Formik
//               enableReinitialize
