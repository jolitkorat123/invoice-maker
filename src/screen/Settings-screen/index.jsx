...
//   // Inject selectedCurrency dynamically
//   const settingsData = [
//     {
//       label: 'Business Info',
//       icon: require('../../../assets/screen-24/business-info.png'),
...
//       icon: require('../../../assets/screen-24/default-currency.png'),
//       navigateTo: 'Currency-screen',
//       value: selectedCurrency?.code || 'INR ₹', // dynamic currency
//     },
//     {
//       label: 'Number Format',
//       icon: require('../../../assets/screen-24/number-format.png'),
...
//     {items.map((item, index) => {
//       const value =
//         item.label === "Default Currency"  ? `${selectedCurrency.symbol} ${selectedCurrency.code}` : item.value;
...
const SettingsScreen = () => {
  ...
  const settingsData = [
    ...
    },
    {
      ...
      icon: require('../../../assets/screen-24/signature.png'),
      navigateTo: 'Signature-list',
      from: 'settings', // ✅ important for condition
    },
  ];
      ...
      {items.map((item, index) => {
        ...
        return (
          <TouchableOpacity
            ...
            onPress={() =>
              item.from
                ? navigation.navigate(item.navigateTo, { from: item.from }) // ✅ pass param if exists
