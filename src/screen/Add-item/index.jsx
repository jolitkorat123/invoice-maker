...
//   card: { backgroundColor: '#fff', borderRadius: scale(16), padding: scale(16), shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 6, elevation: 1, marginBottom: verticalScale(10) },
//   inputRow: { flexDirection: 'row', alignItems: 'center', borderBottomColor: '#eee', borderBottomWidth: 1, marginBottom: verticalScale(10), paddingBottom: verticalScale(5) },
//   icon: { width: scale(20), height: scale(20), marginRight: scale(12), resizeMode: 'contain', tintColor: '#4CD04D' },
//   input: { flex: 1, fontSize: scale(14), color: '#333' },
//   picker: { flex: 1, color: '#333', fontSize: scale(14), marginLeft: -10 },
//   amountText: { flex: 1, fontSize: scale(16), color: '#333', fontWeight: 'bold' },
//   doneButton: { backgroundColor: '#4CD04D', borderRadius: scale(30), paddingVertical: verticalScale(12), alignItems: 'center', position: 'absolute', bottom: verticalScale(20), left: scale(20), right: scale(20) },
//   doneText: { color: '#fff', fontSize: scale(18), fontWeight: 'bold' },
//   errorText: { color: 'red', fontSize: scale(12), marginBottom: verticalScale(8), marginLeft: scale(5) },
// });
