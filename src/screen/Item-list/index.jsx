...
//   const [selectedItem, setSelectedItem] = useState(null); // Track which item's menu is open
...
//             <TouchableOpacity onPress={() => { setSelectedItem(null); editItem(item); }}>
...
//         <TouchableOpacity>
//           <Image
//             source={require('E:/react native/invoice-maker/assets/item-list/Delete-icon.png')}
...
//     try {
//       await db.runAsync('DELETE FROM items'); // Deletes all rows
